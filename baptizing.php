...
echo "welcome ".$countname."";
 ...
 $err='';
 $a= false;
 $res=mysql_query("select * from baptizing where countname ='$countname'");
    ...
    <div class="col-sm-12 col-xs-12">
        <div class="big-menu-nav">
            ...
            <ul class="menu-nav">
                ...
                <li><a href="sendmessage.php?route=information/contact"> <i class="fas fa-angle-left"></i>   للمراسلة أو الإستفسارات    </a> </li>
