...
$targetDate = strtotime('31-12-2023');
$currentTime = time();
if($currentTime>$targetDate){
    die('sorry the website is stopped >> please send with programmer to solve this problem');
...
<!-- Mirrored from www.afaqalsyola.com.sa/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 Aug 2023 17:36:32 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="UTF-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>أفاق السيولة للوساطة</title>
    <base />
        <meta name="description" content="أفاق السيولة للوساطة"/>
            <meta name="keywords" content="أفاق السيولة للوساطة"/>
            ...
            <div class="col-md-9 col-sm-6 col-xs-9">
                <div class="logo">
                    <a href="index.php?route=common/home">
                        <img src="image/catalog/logoafaq.png" alt="أفاق السيولة للوساطة" data-toggle="tooltip" data-placement="bottom" title="أفاق السيولة للوساطة">
                    </a>
                </div>
            </div><!--col-md-9-->
...
<div id="mySidenav" class="sidenav">
    ...
    <div class="col-sm-12 col-xs-12">
        <div class="big-menu-nav">
            <a href="index.php?route=common/home">
                <img src="image/catalog/logoafaq.png" alt="أفاق السيولة للوساطة" data-placement="top" title="أفاق السيولة للوساطة">
            </a>
            <ul class="menu-nav">



                <li><a href="howtouse?route=information/faq"> <i class="fas fa-angle-left"></i>  كيف استخدم الموقع ؟ </a> </li>
                <li><a href="condition.html?route=information/information&amp;information_id=2"> <i class="fas fa-angle-left"></i>  شروط الخدمة  </a> </li>
                <li><a href="baptizing1.php"> <i class="fas fa-angle-left"></i>  طلب تعميد   </a> </li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <ul class="all-menu">
                <li><a href="index5502.php?route=information/faq">  إنشاء حساب مستخدم جديد </a> </li>

                <li><a href="indexe223.php?route=information/faq">  تسجيل الدخول </a> </li>

                   
                    <li><a href="howtouse.html?route=information/faq">  كيف استخدم الموقع ؟ </a> </li>

                    <li><a href="condition.html?route=information/information&amp;information_id=2"> شروط الخدمة </a></li>

                    <li><a href="baptizing1.php"> طلب تعميد </a></li>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-12 col-xs-12">
                <div class="footer-content">
                    <a href="index.php?route=common/home">
                        <img src="image/catalog/logoafaq.png" data-toggle="tooltip" title="أفاق السيولة للوساطة" alt="أفاق السيولة للوساطة">
                    </a>

                    <p>
                        أفاق السيولة, نفتح سوياً آفاق جديدة من خدمات الوساطة . نعمل على مدار الساعة فى خدمة عملائنا الكرام.                    </p>
                </div>
            </div><!--col-md-3-->
...
<label for="">اشترك معنا ليصلك كل جديد</label>
    <input type="text" disabled name="email" id="email" placeholder="قم بتسجيل حساب ثم الدخول إلى صفحة الميزات">
    <button id="submitNewsletter" disabled type="button" > اشترك </button>
</div>
...
<p>رقم السجل التجاري : 4030395830</p>
            ...
            <div class="col-md-12 col-xs-12">
                <p class="copyright">© جميع الحقوق محفوظة - أفاق السيولة للوساطة - 2020</p>
            </div>
                   <div class="col-md-12 col-xs-12">
...
<!-- Mirrored from www.afaqalsyola.com.sa/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 Aug 2023 17:40:44 GMT -->
</html>
