...
else
{
 ...
 if(!$a){
 if(isset($_POST["add"])){
  $sqls="insert into counts(count_user,count_name,count_email,count_telephone,count_pass,count_hr,count_date)values('$count_user','$count_name','$count_email','$count_telephone','$count_pass','$date1','$date')";
  //echo $sqls;
 $r=mysql_query($sqls);
 $err="added";
        ...
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <div class="login-page">
                    ...
                    <form name="f" class="sign-up-form" method="post" enctype="multipart/form-data">

                        <label>اسم المستخدم</label>
                        <input type="text" name="count_user" value="" placeholder="(باللغة الإنجليزية) اختر اسم مختصر لائق و ذو معنى ..." />
                        ...
                        <input type="button" value="تأكد من تطابق كلمتا المرور ثم إضغط إرسال" onclick="return ok();"/>
                                                <script>
                        function ok(){
                        if(f.count_pass.value !== f.confirm.value){
                        alert ("كلمتا المرور غير متطابقة");
                        return false;
                        }
                        alert ("كلمتا المرور متطابقة");
                        }
                        </script>
                        <?php
