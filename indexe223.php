...
<!-- Mirrored from www.afaqalsyola.com.sa//index.php?route=account/login by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 Aug 2023 17:44:22 GMT -->
...
if(isset($_POST['add'])){
	...
	echo"connect";
    $con->select_db("syola");
	$res=$con->query("select * from counts where count_user='".$_POST['count_user']."' and count_pass='".$_POST['count_pass']."'");
	if($res->num_rows>0){
        session_start();
         $countname =$_POST['count_user'];
        $_SESSION['countname']=$countname;
        header("location: index9328.php");
    }
	else{
    
        //echo "<font color='red'>هناك خطأ في اسم المستخدم أو كلمة المرور</font>";
        echo "<script>alert ('هناك خطأ في اسم المستخدم أو كلمة المرور');</script>";
    }	
}
?>
    ...
    <div class="col-sm-12 col-xs-12">
        <div class="big-menu-nav">
            ...
            <ul class="menu-nav">
                ...
                <li><a href="howtouse.html?route=information/faq"> <i class="fas fa-angle-left"></i>  كيف استخدم التطبيق ؟ </a> </li>
        ...
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <ul class="all-menu">
                    ...
                    <li><a href="howtouse.html?route=information/faq">  كيف استخدم التطبيق ؟ </a> </li>
...
<div class="road">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-xs-12">
                <h4> <i class="fas fa-caret-left"></i> تسجيل الدخول إلى حسابك </h4>
                <p> سجل دخول الآن فى آفاق السيولة وتمتع بكافة المزايا </p>
            </div><!--col-sm-12-->
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <div class="login-page">
                    ...
                    <form action="<?php $_SERVER['PHP_SELF'];?>" class="sign-in-form" method="post" enctype="multipart/form-data">

                        <label>اسم المستخدم</label>
                        <input type="text" name="count_user" value=""
                               placeholder="" />
                        <span> <i class="fas fa-user"></i> </span>


                        <label>كلمة المرور</label>
                        <input type="password" name="count_pass" value=""
                               placeholder="" id="myInput"/>
                        <span> <i class="fas fa-lock"></i> </span>
                        <span class="eye"> <i class="fas fa-eye" onclick="myFunction()"></i> </span>

                        
                        <button type="submit" name="add"> تسجيل الدخول </button>

                        <a href="indexacda.html?route=account/forgotten"> هل نسيت كلمة المرور ؟ </a>
                        <p> ليس لديك حساب شخصى؟ <a href="index5502.html?route=account/register"> سجل حسابك الآن! </a> </p>
...
<!-- Mirrored from www.afaqalsyola.com.sa//index.php?route=account/login by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 Aug 2023 17:44:29 GMT -->
</html>