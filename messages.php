...
<head>
    ...
    <title>الرسائل والإستفسارات</title>
    <base />
...
<section class="terms-service">
  ...
  <table id='tbl'>
   ...
   <?php
     ...
     echo "<td>".$row['ms_obj']."</td>";
          echo "<td>".$row['ms_message']."</td>";
               echo "<td>".$row['ms_phon']."</td>";
               echo "<td>".$row['ms_hr']."</td>";
               echo "<td>".$row['ms_date']."</td>";
